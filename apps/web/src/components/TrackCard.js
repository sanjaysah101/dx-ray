...
const trackMeta = {
  git: {
    icon: "📊",
    label: "Git Analysis",
    description: "Commit patterns, hotspots, bus factor",
  },
  "code-quality": {
    icon: "🔍",
    label: "Code Quality",
    description: "Tooling, type safety, complexity",
  },
  cicd: {
    icon: "⚙️",
    label: "CI/CD Scanner",
    description: "Pipeline config, caching, security",
  },
  tests: {
    icon: "🧪",
    label: "Test Health",
    description: "Coverage, frameworks, patterns",
  },
  docs: {
    icon: "📝",
    label: "Docs Freshness",
    description: "README quality, staleness",
  },
  dependencies: {
    icon: "📦",
    label: "Dependencies",
    description: "Count, versions, heavy deps",
  },
  "pr-review": {
    icon: "👀",
    label: "PR Review",
    description: "Merge patterns, bottlenecks",
  },
};
  ...
  const scoreColor =
    score >= 80
      ...
      : score >= 60
        ...
        : "text-dx-red";
  const barColor =
    score >= 80 ? "bg-dx-green" : score >= 60 ? "bg-dx-yellow" : "bg-dx-red";
  const statusColor =
    track.severity === "healthy"
      ? "text-dx-green"
